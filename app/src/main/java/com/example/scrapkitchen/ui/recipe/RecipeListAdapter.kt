...
import com.example.scrapkitchen.databinding.RecipeRowBinding
import com.example.scrapkitchen.db.entities.RecipeEnt

class RecipeListAdapter(private val recipeList: List<RecipeEnt>, private val vm:RecipeViewModel, private val listener: RecipeListFragment) : RecyclerView.Adapter<RecipeListAdapter.MyViewHolder>() {
    private val emojis = Emojis.Companion

    inner class MyViewHolder(recipeRowBinding: RecipeRowBinding, private val onRecipeSelected: OnRecipeSelected): RecyclerView.ViewHolder(recipeRowBinding.root),View.OnClickListener {
        init {
